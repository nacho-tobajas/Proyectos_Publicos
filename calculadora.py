...
boton_borrar = Button(ventana, text = "AC", width = 5, height= 2, command= lambda:click_borrar())
boton_parantesis1 = Button(ventana, text = "(", width = 5, height= 2, command= lambda:click_buton("("))
boton_parantesis2 = Button(ventana, text = ")", width = 5, height= 2, command= lambda:click_buton(")"))
...
boton_mult = Button(ventana, text = "x", width = 5, height= 2, command= lambda:click_buton("*"))
...
boton_igual = Button(ventana, text = "=", width = 5, height= 2, command= lambda:obtener_resultado())
